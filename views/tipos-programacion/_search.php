...
/* @var $model app\models\search\TblTiposProgramacionSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="tbl-tipos-programacion-search">
...
<div class="row">
        <?= $form->field($model, 'id_tipo_programacion') ?>

        <?= $form->field($model, 'nombre_tipo_programacion') ?>

</div>
<div class="row">
        <?= $form->field($model, 'descripcion_tipo_programacion') ?>

        <?= $form->field($model, 'intervalo_tipo_programacion') ?>
